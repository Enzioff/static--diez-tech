...
/***/ "./src/assets/sprite/icon-title-sharp.svg":
/*!************************************************!*\
  !*** ./src/assets/sprite/icon-title-sharp.svg ***!
  \************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ({
      id: "icon-title-sharp-usage",
      viewBox: "0 0 48 66",
      url: "/assets/sprite/" + "sprite.svg#icon-title-sharp-usage",
      toString: function () {
        return this.url;
      }
    });
...
/* harmony export */ });
/* harmony import */ var _helpers_values__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helpers/values */ "./src/js/helpers/values.js");
...
class Animate {
	...
	scrollAnimation() {
		window.addEventListener('scroll', ()=> {
			const currentOffset = window.scrollY - this.el.offsetTop + _helpers_values__WEBPACK_IMPORTED_MODULE_0__.values.animMargin;
			if (currentOffset <= 0) {
...
/* harmony import */ var _sliderFactory__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sliderFactory */ "./src/js/sliderFactory.js");
...
/* harmony import */ var _customTabs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./customTabs */ "./src/js/customTabs.js");
/* harmony import */ var _preloader__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./preloader */ "./src/js/preloader.js");
/* harmony import */ var _cases__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./cases */ "./src/js/cases.js");
/* harmony import */ var _scrollToSec__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./scrollToSec */ "./src/js/scrollToSec.js");
/* harmony import */ var _counter__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./counter */ "./src/js/counter.js");
/* harmony import */ var _easter__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./easter */ "./src/js/easter.js");
...
class App {
	...
	initSlider(item) {
		return new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](
			...
			(0,_sliderFactory__WEBPACK_IMPORTED_MODULE_1__["default"])(item),
		);
	}
	...
	initPreloader() {
		...
		if (el) {
			new _preloader__WEBPACK_IMPORTED_MODULE_7__.Preloader(el);
		}
	}
	...
	initCustomTabs() {
		...
		el.forEach(item => new _customTabs__WEBPACK_IMPORTED_MODULE_6__.CustomTabs(item));
	}
	
	initListLinks() {
		const el = document.querySelectorAll("[data-link]");
		el.forEach(item => new _cases__WEBPACK_IMPORTED_MODULE_8__["default"](item, el));
	}
	
	initTabs() {
		const el = document.querySelectorAll("[data-tab]");
		el.forEach(item => new _tabs__WEBPACK_IMPORTED_MODULE_2__.Tabs(item));
	}
	
	initAnimate() {
		const el = document.querySelectorAll("[data-animation]");
		el.forEach(item => new _animate__WEBPACK_IMPORTED_MODULE_3__.Animate(item));
	}
	
	initOneScroll() {
		const el = document.querySelector(".oneScroll");
		if (el) {
			new _scrollToSec__WEBPACK_IMPORTED_MODULE_9__["default"](el)
		}
	}
	...
	initCounter() {
		...
		if (el) {
			new _counter__WEBPACK_IMPORTED_MODULE_10__["default"](el)
		}
	}
	...
	initEaster() {
		...
		if (el) {
			new _easter__WEBPACK_IMPORTED_MODULE_11__["default"](el)
		}
	}
	...
	initModal() {
		...
		if (el) {
			new _modal__WEBPACK_IMPORTED_MODULE_12__["default"](el)
		}
	}
	...
	initToggle() {
		...
		if (el) {
			new _toggle__WEBPACK_IMPORTED_MODULE_13__["default"](el)
		}
	}
}
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(el) {
	const data = {
		...
		slidesPerView: 1,
		spaceBetween: 20,
		slideActiveClass: "swiper-slide--person--visible",
	};
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(el) {
	const data = {
		...
		allowSlidePrevMouse: true,
		allowSlideNextMouse: true,
		allowTouchMove: true,
		breakpoints: {
			1200: {
		...
		window.addEventListener("scroll", () => {
			if (this.el && this.el.parentNode.classList.contains("focused")) {
				if (!this.toggle) {
					...
					let demo = new countup_js__WEBPACK_IMPORTED_MODULE_0__.CountUp(this.el, 10345723, options);
					if (!demo.error) {
						demo.start();
					} else {
...
document.addEventListener("DOMContentLoaded", () => {
	...
	gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to({}, .01, {
		...
		onRepeat: ()=> {
			...
			gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set(aura, {
				css: {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   CustomTabs: function() { return /* binding */ CustomTabs; }
/* harmony export */ });
class CustomTabs {
	constructor(el) {
		this.el = el;
	...
	initEaster() {
		this.boxes.forEach(box => {
			box.addEventListener("click", () => {
				...
				if (window.innerWidth > _helpers_values__WEBPACK_IMPORTED_MODULE_0__.values.desktopWidth) {
					setTimeout(()=> {
...
(function initHeader() {
	...
	if (mainNav) {
		window.addEventListener("scroll", () => {
			if (window.scrollY >= _helpers_values__WEBPACK_IMPORTED_MODULE_0__.values.menuTabletEnd) {
				mainNav.classList.add("main-nav--fixed");
			}
			
			if (window.scrollY <= _helpers_values__WEBPACK_IMPORTED_MODULE_0__.values.menuTabletStart) {
...
/* harmony default export */ __webpack_exports__["default"] = (OneScroll);
...
/* harmony import */ var _config_projects__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./config/projects */ "./src/js/config/projects.js");
/* harmony import */ var _config_about__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./config/about */ "./src/js/config/about.js");
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(el) {
  ...
  if (name === 'projects') return (0,_config_projects__WEBPACK_IMPORTED_MODULE_4__["default"])(el);
  if (name === 'about') return (0,_config_about__WEBPACK_IMPORTED_MODULE_5__["default"])(el);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _assets_images_icon_logo_svg__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../assets/images/icon-logo.svg */ "./src/assets/images/icon-logo.svg");
/* harmony import */ var _assets_sprite_icon_arrow_right_svg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../assets/sprite/icon-arrow-right.svg */ "./src/assets/sprite/icon-arrow-right.svg");
...
/* harmony import */ var _assets_sprite_icon_arrow_top_right_svg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../assets/sprite/icon-arrow-top-right.svg */ "./src/assets/sprite/icon-arrow-top-right.svg");
/* harmony import */ var _assets_sprite_icon_play_svg__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../assets/sprite/icon-play.svg */ "./src/assets/sprite/icon-play.svg");
/* harmony import */ var _assets_sprite_icon_title_sharp_svg__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../assets/sprite/icon-title-sharp.svg */ "./src/assets/sprite/icon-title-sharp.svg");
...
/* harmony default export */ __webpack_exports__["default"] = ({
    logo: _assets_images_icon_logo_svg__WEBPACK_IMPORTED_MODULE_0__["default"],
    iconArrowRight: _assets_sprite_icon_arrow_right_svg__WEBPACK_IMPORTED_MODULE_1__["default"],
	iconArrowLeft: _assets_sprite_icon_arrow_left_svg__WEBPACK_IMPORTED_MODULE_2__["default"],
    iconArrowTopRight: _assets_sprite_icon_arrow_top_right_svg__WEBPACK_IMPORTED_MODULE_3__["default"],
    iconPlay: _assets_sprite_icon_play_svg__WEBPACK_IMPORTED_MODULE_4__["default"],
    iconTitleSharp: _assets_sprite_icon_title_sharp_svg__WEBPACK_IMPORTED_MODULE_5__["default"],
	...
	close: _assets_sprite_icon_close_svg__WEBPACK_IMPORTED_MODULE_8__["default"]
});
...
class Track {
	...
	addFirstEl() {
		...
		if (this.el.scrollLeft <= 0) {
			this.cloneToStart();
			this.el.scrollLeft += this.box.clientWidth + _helpers_values__WEBPACK_IMPORTED_MODULE_0__.values.trackFixValue;
		}
	}
...
/* harmony import */ var _track__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./track */ "./src/js/track.js");
/* harmony import */ var _observer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./observer */ "./src/js/observer.js");
...
/* harmony import */ var _toggle__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./toggle */ "./src/js/toggle.js");
/* harmony import */ var _easter__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./easter */ "./src/js/easter.js");
/* harmony import */ var _preloader__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./preloader */ "./src/js/preloader.js");
...
/* harmony import */ var _scrollToSec__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./scrollToSec */ "./src/js/scrollToSec.js");
/* harmony import */ var _counter__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./counter */ "./src/js/counter.js");
/* harmony import */ var _cursor__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./cursor */ "./src/js/cursor.js");
/* harmony import */ var _css_main_scss__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../css/main.scss */ "./src/css/main.scss");
/* harmony import */ var swiper_swiper_css__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! swiper/swiper.css */ "./node_modules/swiper/swiper.css");
/* harmony import */ var _app__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./app */ "./src/js/app.js");
...
new _app__WEBPACK_IMPORTED_MODULE_17__["default"]();
